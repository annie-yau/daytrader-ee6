...
//import com.ibm.websphere.samples.daytrader.soap.*;
...
public class TradeServletAction {
    ...
    void doAccount(ServletContext ctx, HttpServletRequest req,
        ...
        try {
            ...
            ArrayList<?> orderDataBeans = (TradeConfig.getLongRun() ? new ArrayList<Object>() : (ArrayList<?>) tAction.getOrders(userID));
