 ...
 * This primative uses {@link com.ibm.websphere.samples.daytrader.direct.TradeDirect} to set the price of a random stock
 * (generated by {@link com.ibm.websphere.samples.daytrader.Trade_Config}) through the use of prepared statements. 
 * 
 */
...
// DHV
		...
		catch (Exception e)
		{
			Log.error(
				e,
				"PingJDBCRead2JPS -- error getting quote for symbol",
				symbol);
