...
public class FinancialUtils {
	...
	public static BigDecimal computeHoldingsTotal(Collection<?> holdingDataBeans) {
		...
		while (it.hasNext()) {
			HoldingDataBean holdingData = (HoldingDataBean) it.next(); // ClassCastException: java.util.LinkedHashMap cannot be cast to com.ibm.websphere.samples.daytrader.HoldingDataBean
